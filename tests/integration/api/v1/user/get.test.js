...
describe("GET /api/v1/users/[username]", () => {
  describe("Default user", () => {
    ...
    test("With barely expired session", async () => {
      const NINETY_SECONDS_TO_EXPIRE = 2_591_910_000; // 29 days, 23 hours, 59 minutes and 30 seconds

      jest.useFakeTimers({
        now: new Date(Date.now() - NINETY_SECONDS_TO_EXPIRE),
      });
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "28f24be85c124048c8960a48deccb3e02720a6f6edd69da3e2bd067042865c26527a9cbcdcd96b446e3d8392e9d506a9";
